...
class HorizontalProductAdapter(var listHorizontalProductModel: MutableList<HorizontalProductModel>) : RecyclerView.Adapter<HorizontalProductAdapter.ViewHolder>(){
